    ...
    <div
      ...
      <div class="space-y-4">
        ...
        <label for="reminders-switch" class="flex items-center justify-between pt-2 border-t border-gray-800/50 cursor-pointer">
          ...
          <USwitch id="reminders-switch" v-model="remindersEnabled" color="primary" aria-label="Herinneringsmail inschakelen" />
        </label>
        <label v-if="pushSupported" for="push-switch" class="flex items-center justify-between pt-2 border-t border-gray-800/50 cursor-pointer">
          ...
          <USwitch id="push-switch" v-model="pushEnabled" color="primary" aria-label="Pushberichten inschakelen" />
        </label>
    ...
    <div
      ...
      <div class="w-full flex flex-col gap-y-5">
        ...
        <div class="space-y-4">
          ...
          <label for="pregnancy" class="flex items-center justify-between cursor-pointer">
            <span class="block text-sm font-medium text-gray-300">Ben je zwanger?</span>
