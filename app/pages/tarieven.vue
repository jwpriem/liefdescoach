...
const description = ref(
    "Kies het abonnement dat bij jou past. Losse lessen, strippenkaarten of een introductieaanbod.",
);
...
<template>
    <div class="min-h-screen bg-gray-950">
        ...
        <div class="bg-emerald-900 text-white relative overflow-hidden pt-40">
            <div class="absolute inset-0 opacity-20">
                <img
                    ...
                    alt="Yoga Ravennah background"
                />
            </div>
            <div
                class="absolute inset-0 bg-gradient-to-b from-transparent to-emerald-900/90"
            ></div>
            ...
            >
                ...
                <p
                    class="text-xl md:text-2xl text-emerald-100 max-w-2xl mx-auto font-light"
                >
                    Flexibele opties voor elke yogi. Van losse lessen tot
                    voordelige strippenkaarten.
                </p>
            </div>
        </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div
                    ...
                    :class="{
                        'ring-2 ring-emerald-500': plan.highlight,
                        'ring-2 ring-yellow-500': plan.gold,
                    }"
                >
                    <!-- Badge -->
                    <div
                        v-if="plan.tag"
                        class="text-xs font-bold uppercase tracking-wider text-center py-1.5"
                        :class="
                            plan.gold
                    ...
                    <div class="p-6 flex-grow flex flex-col">
                        <h3 class="text-xl font-bold text-emerald-100 mb-2">
                            {{ plan.name }}
                        </h3>
                        <div class="mb-4">
                            <span
                                class="text-3xl font-black text-emerald-100"
                                >{{ plan.price }}</span
                            >
                            <span
                                v-if="plan.credits"
                                class="text-emerald-500 text-sm font-medium block mt-1"
                                >{{ plan.credits }}</span
                            >
                        </div>
                        ...
                        <ul class="space-y-3 mb-8 flex-grow">
                            ...
                            >
                                <svg
                                    class="w-5 h-5 text-emerald-500 mr-2 flex-shrink-0"
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                >
        ...
        <!-- Additional Info -->
        <div
            class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 mb-16 text-center text-neutral-600"
        >
            <h3 class="text-lg font-bold text-neutral-900 mb-4">
                Goed om te weten
            </h3>
            <div
                class="grid grid-cols-1 md:grid-cols-2 gap-8 text-neutral-600 text-sm text-left"
            >
                <div
                    class="bg-emerald-500 p-6 rounded-xl border border-emerald-400/50 backdrop-blur-sm shadow-2xl shadow-emerald-950/20"
                >
                    <svg
                        class="w-6 h-6 text-emerald-900 mb-3"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                    >
                    ...
                    <p class="text-emerald-950">
                        Strippenkaarten hebben een vaste geldigheidsduur vanaf
                        het moment van aankoop. Check de geldigheid per kaart.
                    </p>
                </div>
                <div
                    class="bg-emerald-500 p-6 rounded-xl border border-emerald-400/50 backdrop-blur-sm shadow-2xl shadow-emerald-950/20"
                >
                    ...
                    <p class="text-emerald-950">
                        Met een account kun je eenvoudig lessen boeken en
                        annuleren. Annuleren is kosteloos tot 24 uur van
                        tevoren.
                    </p>
                </div>
            </div>
            ...
            <p v-if="!loggedInUser" class="mt-8 text-emerald-500">
                ...
                <nuxt-link
                    ...
                    >Log in of registreer</nuxt-link
                >
                om te boeken.
            </p>
        </div>
