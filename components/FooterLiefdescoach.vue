    ...
    <div class="container mx-auto">
      <div class="md:flex justify-between items-start space-y-8 md:space-y-0">
        <div class="w-full md:w-2/4">
          <svg
            class="w-12 h-12 block stroke-current text-white mb-8"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          ...
          <small>&copy; www.ravennah.com/liefdescoach</small><br>
          <nuxt-link to="/yoga" class="text-rose-900">
            <small>Ga naar Yoga Ravennah</small>
          </nuxt-link>
        </div>
        <div class="w-full md:w-1/6">
          <h6 class="uppercase font-bold text-rose-900">
            Menu
          </h6>
          <ul class="font-light">
            <li>
              <nuxt-link to="/liefdescoach/over">
                Over mij
              </nuxt-link>
            </li>
            <li>
              <nuxt-link to="/liefdescoach/digitale-coach">
                Digitale coach
              </nuxt-link>
            </li>
            <li>
              <nuxt-link to="/liefdescoach/kosten">
                Kosten
              </nuxt-link>
            </li>
            <li>
              <nuxt-link to="/liefdescoach/oplichters">
                Oplichters
              </nuxt-link>
            </li>
            <li>
              <nuxt-link to="/liefdescoach/contact">
                Contact
              </nuxt-link>
            </li>
          </ul>
        ...
        <div class="w-full md:w-1/4">
          ...
          <ul>
            ...
            <li @click="track('instagram')">
              ...
              <a
                href="https://www.instagram.com/liefdescoachrotterdam"
                target="_blank"
                >@liefdescoachrotterdam</a
              >
            </li>
          </ul>
        </div>
